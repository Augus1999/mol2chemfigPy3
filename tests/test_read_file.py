...
-[@{a6-7}:276,,,1]@{a7}NH-[@{a7-8}:204,,1]@{a8}(-[@{a4-8}:132])}"""
    ...
    target3 = r"""\chemfig{@{a1}^{\mcfplus}H_3N-[@{a1-2}:24,,3]@{a2}-[@{a2-3}:324]@{a3}%
-[@{a3-4}:24]@{a4}-[@{a4-5}:330]@{a5}(%
-[:96,0.85,,,draw=none]\mcfcringle{1.03})-[@{a5-6}:42]@{a6}%
-[@{a6-7}:114]@{a7}\mcfabove{N}{H}-[@{a7-8}:186]@{a8}(-[@{a4-8}:258])}"""
